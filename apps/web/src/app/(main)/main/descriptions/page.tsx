  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] p-6 md:p-10 max-w-5xl mx-auto w-full">
      <div className="flex flex-col gap-2 mb-10">
        <h1 className="text-3xl font-heading font-semibold text-foreground">Descriptions</h1>
        <p className="text-muted text-base">Genera descripciones para tus productos con Inteligencia Artificial.</p>
      </div>
