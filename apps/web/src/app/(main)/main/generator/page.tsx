        ...
        <section className="flex flex-col gap-4 border-b border-border pb-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            {selectedClothes.map(item => (
              <div key={item.id} className="relative aspect-square rounded-xl overflow-hidden border border-border">
                  ...
                  {libraryItems
                    ...
                    .map(item => {
                      ...
                      return (
                        ...
                        >
                          <div className={`relative aspect-square rounded-xl overflow-hidden border-2 transition-all ${isSelected ? 'border-foreground shadow-sm' : 'border-border group-hover:border-foreground/50'}`}>
